...
if current_tree is None:
    crossnode = CrossSplit(adtdata.copy(),rnadata.copy(),merge_cutoff)
else:
    nodelist = []
    ...
    crossnode = dfs(crossnode, adtdata, rnadata.copy(), merge_cutoff, nodeid=FinetuneNonde, ifretrain=ifretrain)
